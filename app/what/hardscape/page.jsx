    ...
    <main className="bg-white min-h-screen pt-[230px] py-20 px-4 flex flex-col items-center">
      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8 text-base text-justify leading-relaxed font-sans mb-16">
        <p className="text-base font-sans leading-relaxed">
          Simply put, hardscape is any of the non-living elements in your landscape design, the harder design elements in your garden.
          These elements form the foundation of the garden, separating the softer living elements and creating usable spaces.
        </p>
        <p> The hardscaping elements are also what is not visual such as drainage and irrigation.
        As with any construction project, the foundation has to be right so the garden can mature and thrive.</p>
      </div>
