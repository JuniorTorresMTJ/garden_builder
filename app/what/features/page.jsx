    ...
    <main className="bg-white min-h-screen pt-[220px] md:pt-[250px] px-4 py-20 flex flex-col items-center">
      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8 text-base text-justify leading-relaxed font-sans mb-16">
        <p className="text-base font-sans leading-relaxed">
          We are a garden design and build landscaping company. This includes
          garden design and both the hard and soft elements of landscaping.
        </p>
        <p>
          We are also experienced with more bespoke features such as installing
          outdoor kitchens, water features, pergolas, fire tables, irrigation
          systems and garden lighting.
        </p>
      </div>

      <div className="max-w-6xl w-full grid grid-cols-2 md:grid-cols-3 gap-6">
        {images.map((src, index) => {
          const isFirstImageWebp = src.includes("features-1.webp");
          return (
            <div
              key={index}
